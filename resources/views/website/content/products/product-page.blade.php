...
{{--                            </div>--}}
                        ...
                        <ul class="usefull-link">
                            <li>
                                @if($isFav)
                                    <button
                                            wire:click="toggleFav({{ $product->id }})" wire:loading.attr="disabled"
                                            style="color: red"
                                            onmouseover="this.style.color='darkred'"
                                            onmouseout="this.style.color='red'"
                                            data-tip="tooltip" title="Click to delete from wishlist"
                                            data-placement="bottom"
                                    >
                                        <i class="glyphicon glyphicon-heart" style="font-size: 16px"></i>
                                        WISHLIST
                                    </button>
                                @else
                                    <button
                                            ...
                                            data-tip="tooltip" title="Click to add to wishlist"
                                            data-placement="bottom"
                                    >
                                        <i class="glyphicon glyphicon-heart-empty" style="font-size: 16px"></i>
                                        WISHLIST
                                    </button>
                                @endif
                            </li>
                            ...
                            <li>
                                <a
                                    ...
                                    data-placement="bottom"
                                >
                                    <i class="icon-envelope-open"></i> Email to a Friend
                                </a>
                            </li>
                            <li>
                                <a
