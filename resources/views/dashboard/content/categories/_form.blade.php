...
<x-dashboard.form.input placeholder="Enter Name of Category" label="Name" class="" name="name" :value="$category->name"/>
...
{{--             value="draft"--}}
{{--             @checked($categories->status=='draft')--}}
{{--             id="customRadioSecondary">--}}
{{--      <label class="form-check-label" for="customRadioSecondary"> Draft </label>--}}
    </div>
  </div>
</div>
